...
exports.Parser.prototype.run = function(originalContext, originalArguments, argumentDescriptions, callback) {
        
    this.originalContext = originalContext;
    this.originalArguments = originalArguments;
    this.originalFunction = originalArguments.callee;
...
exports.Parser.prototype._createArgumentsToApplyObject = function() {
    ...
    function _argument(argumentDescription, index) {
        var argument = {
            index: index,
            value: _this.DEFAULTS_BY_TYPE[argumentDescription.slice(0, -1)]
        };
...
exports.Parser.prototype._or = function(argumentDescriptions, argument, index) {
    for (var i = 0, argumentDescription; (argumentDescription = argumentDescriptions[i]) != null; i++) {
        ...
        if (typeof(argument) === type) {
            this.argumentsToApply[argumentDescription].value = argument;
            return;
        }
    }
